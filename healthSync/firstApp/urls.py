...
# Admin URL
   ...
   path('admin/personnels_a_valider/', views.personnels_a_valider, name='personnels_a_valider'),
    ...
    path('health/hos/doctor-profile/<int:medecin_id>/', views.hos_doctor_profile, name='hos_doctor_profile'),  # hos-doctor-profile.html
    path('hos/delete-doctor/<int:medecin_id>/', views.hos_delete_doctor, name='hos_delete_doctor'), # suppresion medecin
    path('hos/edit-doctor/<int:medecin_id>/', views.hos_edit_doctor, name='hos_edit_doctor'),  # hos-edit-doctor.html
    path('health/hos/edit-patient/<int:patient_id>/', views.hos_edit_patient, name='hos_edit_patient'),  # hos-edit-patient.html
    path('hos/delete-patient/<int:patient_id>/', views.hos_delete_patient, name='hos_delete_patient'),# suppresion patient
    ...
    path('hos/patient-profile/<int:id>/', views.hos_patient_profile, name='hos_patient_profile'),  # hos-patient-profile.html
